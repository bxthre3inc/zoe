...
- **Federated Fabric (`federated.py`)**: Contains an endpoint `/sync/{field_id}` that translates 1m grid data into Cursor on Target (CoT) v2.0 payloads for Inter-agency simulation.
