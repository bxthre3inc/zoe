...
> **Note:** The contents of this Gemini-generated overview have been absorbed and superseded by the canonical project specifications.
>
> Please see:
>
> 1. [`docs/codebase_docs/farmsense-code/BLUEPRINT.md`](../codebase_docs/farmsense-code/BLUEPRINT.md) for strategy and validation parameters.
> 2. [`docs/architecture/FarmSense_Master_Manual.md`](../architecture/FarmSense_Master_Manual.md) for the exhaustive technical summary.
> 3. Individual node specifications in [`docs/specifications/`](../specifications/).
